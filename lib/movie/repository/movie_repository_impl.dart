...
import 'package:movie_app/movie/models/movie_video_model.dart';
...
class MovieRepositoryImpl implements MovieRepository {
  ...
  Future<Either<String, MovieVideosModel>> getVideos({required int id}) async {
    try {
      ...
      return const Left('Error get detail movies videos');
    } on DioException catch (e) {
      if (e.response != null) {
        return Left(e.response.toString());
      }

      return const Left('Another error on get detail movies videos');
    }
  }
